...
grabParent:SetScript("OnLeave", GameTooltip_Hide)
...
scaleSlider:SetScript("OnLeave", GameTooltip_Hide)
...
alphaSlider:SetScript("OnLeave", GameTooltip_Hide)
...
local nudgeLeft = CreateFrame("Button", "Visor2GUINudgeLeft", frame, "UIPanelButtonTemplate")
...
nudgeLeft:SetScript("OnLeave", GameTooltip_Hide)
nudgeLeft:SetScript("OnClick", function() Visor2Nudge:Left() end)

local nudgeRight = CreateFrame("Button", "Visor2GUINudgeRight", frame, "UIPanelButtonTemplate")
...
nudgeRight:SetScript("OnLeave", GameTooltip_Hide)
nudgeRight:SetScript("OnClick", function() Visor2Nudge:Right() end)

local nudgeUp = CreateFrame("Button", "Visor2GUINudgeUp", frame, "UIPanelButtonTemplate")
nudgeUp:SetWidth(20)
...
nudgeUp:SetScript("OnLeave", GameTooltip_Hide)
nudgeUp:SetScript("OnClick", function() Visor2Nudge:Up() end)

local nudgeDown = CreateFrame("Button", "Visor2GUINudgeDown", frame, "UIPanelButtonTemplate")
...
nudgeDown:SetScript("OnLeave", GameTooltip_Hide)
...
editW:SetScript("OnLeave", GameTooltip_Hide)
...
local editWDown = CreateFrame("Button", "Visor2GUIDecreaseWidth", frame, "UIPanelButtonTemplate")
...
editWDown:SetScript("OnLeave", GameTooltip_Hide)
editWDown:SetScript("OnClick", function() Visor2GUI:ButtonWDown() end)

local editWUp = CreateFrame("Button", "Visor2GUIIncreaseWidth", frame, "UIPanelButtonTemplate")
editWUp:SetWidth(20)
...
editWUp:SetScript("OnLeave", GameTooltip_Hide)
...
editH:SetScript("OnLeave", GameTooltip_Hide)
...
local editHDown = CreateFrame("Button", "Visor2GUIDecreaseHeight", frame, "UIPanelButtonTemplate")
...
editHDown:SetScript("OnLeave", GameTooltip_Hide)
editHDown:SetScript("OnClick", function() Visor2GUI:ButtonHDown() end)

local editHUp = CreateFrame("Button", "Visor2GUIIncreaseHeight", frame, "UIPanelButtonTemplate")
editHUp:SetWidth(20)
...
editHUp:SetScript("OnLeave", GameTooltip_Hide)
...
editX:SetScript("OnLeave", GameTooltip_Hide)
...
editY:SetScript("OnLeave", GameTooltip_Hide)
...
-- other buttons
local grab = CreateFrame("Button", "Visor2GUIGrab", frame, "GameMenuButtonTemplate")
grab:SetWidth(60)
grab:SetHeight(25)
...
local done = CreateFrame("Button", "Visor2GUIDone", frame, "GameMenuButtonTemplate")
done:SetWidth(100)
done:SetHeight(25)
done:SetPoint("BOTTOM", 100, 15)
done:SetText(L["Done"])
done:SetScript("OnEnter", function() Visor2GUI:ShowTooltip(L["Exit Visor2 GUI"]) end)
done:SetScript("OnLeave", GameTooltip_Hide)
...
hide:SetScript("OnLeave", GameTooltip_Hide)
...
local confirmCancel = CreateFrame("Button", "Visor2GUICancel", confirm, "GameMenuButtonTemplate")
